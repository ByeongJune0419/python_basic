...
# 블리언(boolean) 타입
# 참/거짓, True/False 울 나타내는 값
d = True
print(type(d))  # <class 'bool'>

# 개발할때 혼동하기 쉬운 변수 타입
# 네임태그(명칭)과 같이 사용하는 숫자값은 문자열 타입으로 사용
# 주민번호 앞자리 961028
e = 961028
print(type(e))
print(e)
...
# v_sum = "사과" + "3000"     # 실행 취소 [Ctrl + Z]
# v_sum = "사과3000"          # 실행 취소 되돌리기 [Ctrl + Y]
...
# 변수 값을 출력할때, 변수명도 같이 출력하면 콘솔창에서 확인하기 용이
money = 13000
